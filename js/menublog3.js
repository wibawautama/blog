...
function stringMenu02(){
var ar = new Array(
"http://wibawautama.github.io/",
"#",
"-",
"blog/post/HHST.html",
"blog/post/Legge_IChing_PartOne.html",
"blog/post/Legge_IChing_PartTwo.html",
//"@",
//"#",
//"-",
...
if (i==j)
    ...
    st = st + "<li><a href=\"http://"+ ar[0] + ar[i]+"\">"+sr[i] + "</a></li>";
}
i++;
} while (sr[i]!="@");
st = st + "</ul>";
...
st = st + "<li><span>"+sr[i] + "</span></li>";
  ...
  if (i==0)
   ...
   var slaman = "http://"+ ar[0];
   
  if (sr[i]!='@') 
  st = st + "<li><a href=\""+ slaman + ar[i]+"\">"+sr[i] + "</a></li>";
}
...
var pil=1;
var strProtocol=["file://", "http://"];
var strBaseAddr=["D:/DNLOADS/New folder/githubblog/", "http://wibawautama.github.io/blog/"];

var ar = new Array(
strBaseAddr[pil], //"D:/DNLOADS/New folder/githubblog/" "http://wibawautama.github.io/blog/",
"#",
"-",
"post/HHST.html",
